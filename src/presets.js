...
export const PRESETS = {
  ...
  glycine_zwitterion: {
    name: '글리신 쯔비터이온',
    atoms: [
      ['N', [-1.15, 0, 0], 1], ['C', [0, 0, 0]], ['C', [1.48, 0, 0]], ['O', [2.14, 1.08, 0]], ['O', [2.14, -1.08, 0], -1],
      ['H', [-1.55, -0.96, 0]], ['H', [-1.55, 0.48, 0.83]], ['H', [-1.55, 0.48, -0.83]], ['H', [0, 0.94, 0.70]], ['H', [0, -0.94, -0.70]],
    ],
    bonds: [[0, 1], [1, 2], [2, 3, 2], [2, 4], [0, 5], [0, 6], [0, 7], [1, 8], [1, 9]],
    note: 'NH₃⁺–CH₂–COO⁻의 형식전하·쯔비터이온 표현 · 용액 pH 평형을 계산하지 않음',
  },
  amp_5mp: {
    name: 'AMP 5′-모노인산염 골격',
    educationalSketch: true,
    atoms: [
      ['N', [-1.55, -1.55, 0], 0, 'adenine'], ['C', [-2.35, -0.72, 0], 0, 'adenine'], ['N', [-2.35, 0.72, 0], 0, 'adenine'], ['C', [-1.40, 0.00, 0], 0, 'adenine'], ['C', [-0.70, 1.21, 0], 0, 'adenine'], ['N', [0.70, 1.21, 0], 0, 'adenine'], ['C', [1.40, 0.00, 0], 0, 'adenine'], ['N', [0.70, -1.21, 0], 0, 'adenine'], ['C', [-0.70, -1.21, 0], 0, 'adenine'], ['N', [-0.70, 2.35, 0], 0, 'adenine'],
      ['C', [-0.15, -2.70, 0]], ['O', [1.05, -2.12, 0]], ['C', [1.85, -3.15, 0]], ['C', [1.10, -4.35, 0]], ['C', [-0.25, -4.00, 0]], ['C', [2.70, -1.95, 0]], ['O', [3.75, -2.65, 0]], ['P', [4.95, -1.85, 0]], ['O', [6.05, -2.55, 0], -1], ['O', [5.25, -0.45, 0], -1], ['O', [4.20, -2.85, 0]],
    ],
    bonds: [[6, 5], [5, 4], [4, 3, 2], [3, 8], [8, 7, 2], [7, 6], [3, 2], [2, 1, 2], [1, 0], [0, 8], [4, 9], [0, 10], [10, 11], [11, 12], [12, 13], [13, 14], [14, 10], [12, 15], [15, 16], [16, 17], [17, 18], [17, 19], [17, 20]],
    note: '아데노신 5′-모노인산염의 골격 모식도 · 인산 음전하와 5′ 방향을 관찰하며 pKa·용매화는 계산하지 않음',
  },
};
...
export function loadPreset(key) {
  ...
  if (p.educationalSketch) m.educationalSketch = true;
  for (const [el, pos, charge = 0, nucleobase = null] of p.atoms) {
    const index = addAtom(m, el, pos, charge);
    if (nucleobase) m.atoms[index].nucleobase = nucleobase;
  }
